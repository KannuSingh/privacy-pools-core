...
hljs.registerLanguage(
  ...
  (function() {
    ...
    return function(hljs) {
      ...
      const PRAGMA_VERSION = {
        className: "meta",
        begin: /pragma\s+solidity\s+[\^0-9\.]+/,
      };
      ...
      return {
        ...
        contains: [
          ...
          // Function definitions
          {
            ...
            contains: [
              ...
              FUNCTION_PARAMS,
              {
                className: "keyword",
                begin:
                  /\b(public|private|internal|external|pure|view|payable|override)\b/,
              },
            ],
            illegal: /\[|%/,
          },
          // Contract, library, and interface definitions
          {
            className: "class",
          ...
          // Custom types (contracts, etc.)
          CUSTOM_TYPE,
          // State variables
          {
            className: "variable",
            begin: /\b[A-Z][A-Z_0-9]+\b/,
            relevance: 0,
          },
          // Events
          {
